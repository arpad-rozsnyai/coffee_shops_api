ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Coffee Shops Api"
  ...
  #
  # Reuses the same User model GraphQL authenticates against, via a Devise session instead of a JWT.
  ...
  #
  # Must match config.sign_out_via in config/initializers/devise.rb (:delete there).
  ...
  #
  # Off - only the per-row delete was asked for.
